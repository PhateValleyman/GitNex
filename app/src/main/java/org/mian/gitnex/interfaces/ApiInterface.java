...
public interface ApiInterface {
    ...
    @POST("org/{org}/repos")
        // create new repository under org
    ...
    @GET("users/{username}/repos")
        // get current logged in user repositories
    ...
    @DELETE("repos/{owner}/{repo}/collaborators/{username}")
        // delete a collaborator from repository
    ...
    @GET("repos/search")
        // get all the repos which match the query string
    ...
    @GET("repos/{owner}/{repo}/contents")
        // get all the files and dirs of a repository
    ...
    @GET("repos/{owner}/{repo}/contents/{fileDir}")
        // get all the sub files and dirs of a repository
    ...
    @GET("user/starred/{owner}/{repo}")
        // check star status of a repository
    ...
    @GET("repos/{owner}/{repo}/subscription")
        // check watch status of a repository
    ...
    @GET("{owner}/{repo}/pulls/{filename}")
        // get pull diff file contents
